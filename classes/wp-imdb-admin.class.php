    ...
    class WP_IMDB_Admin{
      ...
      public function validate_api_key_input($input){
          ...
          if(!WP_IMDB_Score_Validator::is_api_key($input)){
             add_settings_error("wpimdbscore_api_key", "invalid-api-key", "Invalid API Key! Visit <a href='http://www.omdbapi.com/apikey.aspx' target='_blank'>OMDb API's website</a> to get a valid API Key.");
          }
      ...
      public function validate_imdb_icon_url_input($input){
          ...
          if(!WP_IMDB_Score_Validator::is_imdb_icon_url($input)){
             add_settings_error("wpimdbscore_imdb_icon_url", "invalid-imdb-icon-url", "Invalid <ins>IMDb Icon URL</ins>!");
          }
      ...
      public function validate_icon_width_input($input){
          ...
          if(!WP_IMDB_Score_Validator::is_icon_size($input)){
             add_settings_error("wpimdbscore_imdb_icon_width", "invalid-imdb-icon-width", "Invalid <ins>Icon Width</ins>!");
          }
      ...
      public function validate_icon_height_input($input){
          ...
          if(!WP_IMDB_Score_Validator::is_icon_size($input)){
             add_settings_error("wpimdbscore_imdb_icon_height", "invalid-imdb-icon-height", "Invalid <ins>Icon Height</ins>!");
          }
      ...
      public function validate_cache_lasts_input($input){
          ...
          if(!WP_IMDB_Score_Validator::is_cache_lasts($input)){
             add_settings_error("wpimdbscore_cache_lasts", "invalid-cache-lasts", "Invalid value for <ins>Cache lasts</ins>!");
          }
